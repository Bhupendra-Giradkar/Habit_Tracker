            ...
            <div className="w-full m-0 flex h-14 text-black text-lg 
                ...
                <div className="w-[95%] sm:w-[85%] h-full flex justify-between items-center flex-wrap">
                    ...
                    <div className="w-fit h-full flex items-center p-1 overflow-hidden">
                        <NavLink to="/">
                            <img src='https://img.freepik.com/premium-vector/habit-tracker-lettering-modern-hand-written-text-sticker-planner-bright-habit-tracker-text-planning-concept-vector-illustration_565728-508.jpg' alt="logo" className="w-24 mt-2"/>
                        </NavLink>
                    </div>
