...
const AddHabit = () => {
    ...
    return(
        ...
        // main container
        <div className="w-full lg:w-4/5 h-1/2 bg-[#c5f8d0] rounded shadow-md 
                        justify-self-end flex flex-col">
            
            {/* heading of section */}
            <h1 className="text-red-600 text-lg font-semibold text-center mt-1">
                Add Habit
            </h1>
            ...
            <div className="w-4/5 self-center border-t border-indigo-400">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="bg-[#9b80fc]
                                                hover:bg-emerald-500 rounded-sm 
                                                shadow-md p-1 mt-2 text-black 
